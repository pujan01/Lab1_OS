...
int main() {
  ...
  // after the make_tree is called second time, the stack is cleared and top of stack moves back
  // to the same position when it was called during the first time. hence, the value is over-written 
  // during the second call.
  
  printf("Making other things...\n");
  make_other_things();
  // same case here as well. some wierd garbage value is created. 
  printf("Even worse, the value of t1 is now %d\n", t1->value); // stack dump value
